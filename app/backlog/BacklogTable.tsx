                ...
                {view === 'Geral' ? (
                  <>
                    ...
                    <td className="px-4 py-4 max-w-xs">
                       <p className="text-xs font-bold text-zinc-700 dark:text-zinc-300">{item.descricao}</p>
                       <div className="flex flex-wrap items-center gap-1.5 mt-0.5">
                         <span className="text-[10px] text-zinc-400 opacity-60 font-medium">{item.tipo}</span>
                         {item.colaborador && (
                           <>
                             <span className="text-[10px] text-zinc-300">•</span>
                             <span className="text-[10px] text-indigo-500 dark:text-indigo-400 font-bold uppercase tracking-tight">👤 {item.colaborador}</span>
                           </>
                         )}
                       </div>
                    </td>
                       ...
                       <div className="flex items-start gap-4">
                          ...
                          <div>
                            <span className="flex items-center gap-1.5">
                             ...
                             <p className="text-[10px] font-bold text-zinc-400 max-w-[200px]">{item.descricao}</p>
                             {item.colaborador && (
