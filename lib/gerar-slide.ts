...
interface DashboardDataLocal {
  ...
  rankingFalhas?: Array<{ placa: string; falhas: number; mtbf: number }>;
...
export function gerarSlideHTML(data: DashboardDataLocal, periodo: string, categoria: string): string {
  ...
  const rowsFalhas = falhas.length > 0
    ...
    .join('')
    : `<tr><td colspan="4" style="text-align:center;color:#4f6282;padding:24px">Sem dados de falhas no período</td></tr>`;
...
<div class="slide" id="s8">
  ...
  <div class="two-col">
    <div style="background:#111827;border:1px solid #1e293b;border-radius:14px;overflow:hidden">
      <table>
        <thead><tr><th>#</th><th>Placa</th><th style="text-align:center">Falhas</th><th style="text-align:center">MTBF</th></tr></thead>
